  ...
  return (
    <section className="card overflow-hidden">
      <div className="flex items-center gap-2 border-b border-hos-ink-100 bg-gradient-to-r from-hos-gold-50 to-white px-5 py-4">
        <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-hos-ink-800 text-white">
          <UserRound size={17} />
        </span>
        <div>
      ...
      <div className="border-t border-hos-ink-100">
        <button
          ...
          className="flex w-full items-center justify-between px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-hos-ink-500 hover:text-hos-ink-700"
        >
